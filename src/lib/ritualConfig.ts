...
/** Feed / Clean: up to 2 per day (12h cooldown) */
...
export const STREAK_MILESTONES = [
  { days: 3, multiplier: 1.5, label: '3-Day Streak', bonusXp: 3 },
  { days: 7, multiplier: 2, label: '7-Day Streak', bonusXp: 8 },
  { days: 15, multiplier: 3, label: '15-Day Streak', bonusXp: 15 },
] as const;
